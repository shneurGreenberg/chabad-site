...
const Map<String, Map<String, String>> _strings = {
  ...
  'site.tagline': {
    'he': 'בית הכנסת והמרכז הקהילתי היהודי בנובוסיבירסק — בית חם לכל יהודי סיביר',
    'en': 'The synagogue and Jewish community center in Novosibirsk — a home for every Jew in Siberia',
    'ru': 'Синагога и еврейский общинный центр Новосибирска — дом для каждого еврея Сибири',
  },
  // Navigation
  ...
  'gallery.photos': {'he': 'תמונות', 'en': 'photos', 'ru': 'фото'},
  'gallery.openAlbum': {
    'he': 'פתיחת האלבום',
    'en': 'Open album',
    'ru': 'Открыть альбом'
  ...
  'gallery.emptyAlbum': {
    'he': 'עדיין אין תמונות באלבום הזה',
  ...
  'contact.chooseTopic': {
    'he': 'בחרו נושאים להרשמה — אפשר לבחור כמה ביחד',
    'en': 'Choose topics to register for — you can pick several',
    'ru': 'Выберите темы — можно отметить несколько'
  },
  'contact.needTopic': {
    'he': 'בחרו לפחות נושא אחד',
    'en': 'Please choose at least one topic',
    'ru': 'Выберите хотя бы одну тему'
  },
  'contact.thanks': {
  ...
  'search.group.gallery': {'he': 'גלריה', 'en': 'Gallery', 'ru': 'Галерея'},
  'admin.persist.note': {
  ...
  'admin.appearance.subtitle': {
    'he': 'בחרו פלטת צבעים לכל האתר. חלק מהפלטות במצב כהה.',
    'en': 'Pick a coordinated palette for the whole site. Some looks are dark mode.',
    'ru': 'Выберите палитру для всего сайта. Часть вариантов — тёмные.',
  },
  'admin.appearance.dark': {'he': 'מצב כהה', 'en': 'Dark mode', 'ru': 'Тёмная'},
  'admin.appearance.light': {'he': 'מצב בהיר', 'en': 'Light mode', 'ru': 'Светлая'},
  'admin.siteContent': {'he': 'תוכן האתר', 'en': 'Site content', 'ru': 'Содержание сайта'},
  'admin.siteContent.subtitle': {
    'he': 'שם, סלוגן, אודות, כתובת, שעות וצוות — הכל ניתן לעריכה.',
    'en': 'Name, tagline, about text, address, hours and staff are all editable.',
    'ru': 'Название, слоган, текст «о нас», адрес, часы и сотрудники — всё можно править.',
  },
  'admin.site.name': {'he': 'שם האתר', 'en': 'Site name', 'ru': 'Название сайта'},
  'admin.site.city': {'he': 'עיר', 'en': 'City', 'ru': 'Город'},
  'admin.site.tagline': {'he': 'סלוגן', 'en': 'Tagline', 'ru': 'Слоган'},
  'admin.site.aboutSubtitle': {
    'he': 'כותרת משנה באודות',
    'en': 'About subtitle',
    'ru': 'Подзаголовок «О нас»',
  },
  'admin.site.aboutBody': {
    'he': 'סיפור הקהילה',
    'en': 'Community story',
    'ru': 'История общины',
  },
  'admin.hours': {'he': 'שעות ופעילויות', 'en': 'Hours & activities', 'ru': 'Часы и занятия'},
  'admin.hours.day': {'he': 'יום / נושא', 'en': 'Day / topic', 'ru': 'День / тема'},
  'admin.hours.value': {'he': 'שעות / פירוט', 'en': 'Hours / details', 'ru': 'Часы / подробности'},
  'admin.staff': {'he': 'צוות', 'en': 'Staff', 'ru': 'Сотрудники'},
  'admin.staff.role': {'he': 'תפקיד', 'en': 'Role', 'ru': 'Должность'},
  'admin.manage.famous': {
    'he': 'יהודים מפורסמים',
    'en': 'Notable Jews',
    'ru': 'Известные евреи',
  ...
  'admin.manage.donate': {
    ...
    'ru': 'Кампании пожертвований',
  },
  'admin.manage.cemetery': {
    'he': 'בית החיים',
    'en': 'Cemetery',
    'ru': 'Кладбище',
  },
  ...
  'admin.grave.birth': {'he': 'שנת לידה', 'en': 'Birth year', 'ru': 'Год рождения'},
